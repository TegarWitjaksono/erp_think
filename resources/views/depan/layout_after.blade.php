    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="{{ url('img/image.png') }}" alt="Sabasa Logo" height="40px" width="40px">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('siswaIn') || Request::is('kelas/*') ? 'active' : '' }}" href="{{ route('siswaIn') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('jadwal') ? 'active' : '' }}"
                            ...
                            <i class="fas fa-clipboard"></i> Jadwal Saya
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('logout') ? 'active' : '' }}" href="{{ route('actionLogout') }}">
