                    ...
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center">
                            <div class="mr-3 p-3 rounded-circle" style="background-color: rgba(121, 82, 59, 0.15);">
                                <i class="fas fa-globe-americas fa-2x" style="color: #79523B;"></i>
                            </div>
                            <div>
                                <h1 class="m-0 font-weight-bold" style="color: #4A2C1A;">Edit Origin</h1>
                                <div style="height: 3px; width: 60px; background: linear-gradient(to right, #79523B, #D2B48C); margin-top: 5px; border-radius: 3px;"></div>
                                <p class="text-muted mt-2 mb-0">Manage coffee bean geographical origins</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="float-sm-right mt-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-transparent p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active font-weight-bold" aria-current="page">Origin</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('master_origin.update', $data->id_origin) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('master_origin.index') }}" class="btn btn-secondary">Batal</a>
                            </div>
                        </form>
                    </div>
                </div>
