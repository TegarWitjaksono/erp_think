                ...
                <div class="row mb-2 align-items-center">
                    <div class="col-sm-6 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="mt-1 mb-2"
                                style="height: 3px; width: 60px; background: linear-gradient(to right, #79523B, #D2B48C); border-radius: 3px;">
                            </div>
                        ...
                        <nav aria-label="breadcrumb" class="float-sm-right mt-3">
                            <ol class="breadcrumb bg-transparent p-0 mb-0">
                                <li class="breadcrumb-item">
                                    <a href="/home" class="text-decoration-none" style="color: #79523B;"><i
                                            class="fas fa-home"></i> Home</a>
                                </li>
                                <li class="breadcrumb-item active font-weight-bold" aria-current="page">Post Roast Blends
                                    Detail</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <form action="{{ route('inventory.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kadar_air" id="kadar_air"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bulk_densitas" id="bulk_densitas"
                                class="form-control @error('bulk_densitas') is-invalid @enderror"
                                value="{{ old('bulk_densitas') }}" required>
                            @error('bulk_densitas')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" name="debit_qty" id="debit_qty"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="credit_qty" id="credit_qty"
