                        ...
                        <table id="roastBlendsTable" class="table table-striped table-hover text-nowrap mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('post-roast-blends.edit', $blend->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                        <button type="button" class="btn btn-sm btn-danger delete-btn" data-id="{{ $blend->id }}" data-toggle="modal" data-target="#deleteModal">Hapus</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
