                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h1 class="m-0 font-weight-bold" style="color: #4A2C1A;">Edit Master Proses</h1>
                                 <div style="height: 3px; width: 60px; background: linear-gradient(to right, #79523B, #D2B48C); margin-top: 5px; border-radius: 3px;"></div>
                                <p class="text-muted mt-2 mb-0">Ubah data proses produksi</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="float-sm-right mt-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-transparent p-0 mb-0">
                                     ...
                                     <li class="breadcrumb-item"><a href="{{ route('master_proses.index') }}" style="color: #79523B;">Master Proses</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('master_proses.update', $data->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="nama_proses">Nama Proses</label>
                                <input type="text" name="nama_proses" id="nama_proses" class="form-control @error('nama_proses') is-invalid @enderror" value="{{ old('nama_proses', $data->nama_proses) }}" required>
                                @error('nama_proses')
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('master_proses.index') }}" class="btn btn-secondary">Batal</a>
                            </div>
                        </form>
                    </div>
                </div>
