...
@section('konten')
                        ...
                        <div class="float-sm-right mt-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-transparent p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active font-weight-bold" aria-current="page">Master Barang</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $s)
                                        <tr>
                                            ...
                                            <td>{{ $s->nama_barang }}</td>
                                            <td>
                                                <a href="{{ route('master_barang.edit', base64_encode($s->id_barang)) }}"
                                                    class="btn btn-warning btn-sm">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button type="button" class="btn btn-danger btn-sm delete-btn"
                                                    data-id="{{ $s->id_barang }}" data-toggle="modal"
    ...
    <!-- Modal Tambah Barang -->
    <div class="modal fade" id="tambahBarang" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete this barang record? This action cannot be undone.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.delete-btn').click(function() {
                var id = $(this).data('id');
                var url = "{{ route('master_barang.destroy', ':id') }}";
