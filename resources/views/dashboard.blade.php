            ...
            <div class="menu-area">
                <nav class="mt-1">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-header">Chat Audio</li>

                        <li class="nav-item">
                            <a href="#" class="nav-link" data-toggle="collapse" data-target="#chat">
                                <i class="fas fa-folder-open"></i>
                                <p>Chat <i class="fas fa-chevron-down float-right"></i></p>
                            </a>
                            <ul id="chat" class="collapse nav flex-column">

                                <li class="nav-item">
                                    <a href="{{ url('chat-audio') }}"
                                        class="nav-link">
