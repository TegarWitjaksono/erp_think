    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Detail Nilai Siswa Kelas {{ $results->first()->nama_kelas ?? 'Tidak Diketahui' }}
                        </h1>
        ...
        <section class="content">
            <div class="container-fluid">
                <!-- Tombol Ekspor -->
                <a href="{{ route('detail_nilai.all.export') }}?id_kelas={{ request('id_kelas') }}&id_quiz={{ request('id_quiz') }}&id_materi={{ request('id_materi') }}"
                            ...
                            function renderMedia($content)
                            {
                                ...
                                if (strpos($content, 'uploads/') !== false) {
                                    if (in_array($ext, ['jpg', 'jpeg', 'png', 'gif'])) {
                                        return '<img src="' .
                                            asset($content) .
                                            '" alt="Media" width="100" class="img-fluid d-block mx-auto">';
                                    }
