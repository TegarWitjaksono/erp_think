                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h1 class="m-0 font-weight-bold" style="color: #4A2C1A;">Level Roast</h1>
                                <div style="height: 3px; width: 60px; background: linear-gradient(to right, #79523B, #D2B48C); margin-top: 5px; border-radius: 3px;"></div>
                                <p class="text-muted mt-2 mb-0">Manage your coffee bean Level Roast</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="float-sm-right mt-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-transparent p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active font-weight-bold" aria-current="page">Level Roast</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="content">
            <div class="container-fluid">
                {{-- <button type="button" class="btn btn-coffee mb-3" data-toggle="modal" data-target="#tambahSuppliers">
                    <i class="fas fa-plus-circle mr-2"></i> Add Level Roast
                </button> --}}
    ...
    <div class="modal fade" id="tambahSuppliers" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('master_suppliers.store') }}" Level Roast="POST">
                    @csrf
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <form id="deleteForm" Level Roast="POST" style="display:inline;">
                        @csrf
                        @Level Roast('DELETE')
