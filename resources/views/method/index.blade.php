                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h1 class="m-0 font-weight-bold" style="color: #4A2C1A;">Method</h1>
                                <div style="height: 3px; width: 60px; background: linear-gradient(to right, #79523B, #D2B48C); margin-top: 5px; border-radius: 3px;"></div>
                                <p class="text-muted mt-2 mb-0">Manage your coffee bean Method</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="float-sm-right mt-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-transparent p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active font-weight-bold" aria-current="page">Method</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="content">
            <div class="container-fluid">
                {{-- <button type="button" class="btn btn-coffee mb-3" data-toggle="modal" data-target="#tambahSuppliers">
                    <i class="fas fa-plus-circle mr-2"></i> Add Method
                </button> --}}
