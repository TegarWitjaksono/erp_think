                    ...
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center">
                            <div class="mr-3 p-3 rounded-circle" style="background-color: rgba(121, 82, 59, 0.15);">
                                <i class="fas fa-seedling fa-2x" style="color: #79523B;"></i>
                            </div>
                            <div>
                                ...
                                <p class="text-muted mt-2 mb-0">Manage coffee bean varieties and cultivars</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="float-sm-right mt-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-transparent p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active font-weight-bold" aria-current="page">Varietas</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
