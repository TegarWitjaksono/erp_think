                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $s)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('master_varietas.edit', base64_encode($s->id_varietas)) }}"
                                                    class="btn btn-warning btn-sm">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button type="button" class="btn btn-danger btn-sm delete-btn"
                                                    data-id="{{ $s->id_varietas }}" data-toggle="modal"
    ...
    <div class="modal fade" id="tambahSuppliers" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('master_varietas.store') }}" method="POST">
                    @csrf
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.delete-btn').click(function() {
                var id = $(this).data('id');
                var url = "{{ route('master_varietas.destroy', ':id') }}";
