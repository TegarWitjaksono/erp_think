    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <!-- Tombol Impor -->
                <button type="button" class="btn btn-info mb-3" data-toggle="modal" data-target="#importUserModal">
                    Import Excel
                </button>
                <a href="{{ route('users.template') }}" class="btn btn-danger mb-3">Template Excel</a>
                            ...
                            <tbody>
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($user->role == 1)
                                                {{ optional($user->masterGuru)->nip ?? '-' }}
                                            @elseif ($user->role == 0)
                                                {{ optional($user->masterSiswa)->nip ?? '-' }}
                                            @elseif ($user->role == 2)
                                                {{ $user->nip ?? '-' }} {{-- Display NIP directly from User model for admin --}}
                                            @else
                                                -
                                            @endif
                                        </td>
                                        <td>
                                            {{ $user->jurusan ? $user->jurusan->nama_jurusan : 'Tidak ada jurusan' }}
                                        </td>
                                        <td>
                                            @if ($user->role == 0)
                                                {{ optional($user->masterSiswa)->kelas->nama_kelas ?? 'Tidak ada kelas' }}
                                            @else
                                                -
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                data-target="#resetPasswordModal{{ $user->id }}" title="Reset Password">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('master_user.destroy', $user->id) }}"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <div class="alert alert-info">
                                                            ...
                                                            Ini adalah akun siswa. Pastikan untuk memberitahu password baru kepada siswa yang bersangkutan.
                                                        </div>
                                                        @endif
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{ route('master_user.reset_password', $user->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('POST')
    ...
    <script>
        $(document).ready(function() {
            function toggleFunc() {
                ...
                // Sembunyikan form group jurusan dan kelas terlebih dahulu
                $('#jurusan-group').hide();
                $('#kelas-group').hide();
                
                // Show NIP group for all roles
                $('#nip-group').show();
