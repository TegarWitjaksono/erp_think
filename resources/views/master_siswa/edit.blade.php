                            ...
                            <div class="row">
                                        ...
                                        <select name="id_jurusan" id="jurusan"
                                            ...
                                            @foreach ($jurusan as $jrs)
                                                <option value="{{ $jrs->id_jurusan }}"
                                                    {{ $siswa->id_jurusan == $jrs->id_jurusan ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        <br>
                                        @if (!empty($siswa->foto) && file_exists(public_path('uploads/siswa/' . $siswa->foto)))
                                            <img id="fotoPreview" src="{{ url('uploads/siswa/' . $siswa->foto) }}"
