                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="dashboard-card">
                            <div class="dashboard-card-header">
                                <h2><i class="fas fa-industry"></i> Production Overview</h2>
                                ...
                                <div class="production-timeline">
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-content">
                                            <h4>Arabica Roasting</h4>
                                            <p>Medium roast completed for Aceh Gayo beans</p>
                                            <div class="timeline-meta">
                                                <span><i class="fas fa-clock"></i> Today, 08:30 AM</span>
                                                <span class="badge badge-success">Completed</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item">
                                        <div class="timeline-point in-progress"></div>
                                        <div class="timeline-content">
                                            <h4>Packaging Process</h4>
                                            <p>Packaging 25kg of Sumatra Mandheling for Cafe Nusantara</p>
                                            <div class="timeline-meta">
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <p>Final inspection for Java Preanger batch #JV2023-45</p>
                                            <div class="timeline-meta">
                                                <span><i class="fas fa-clock"></i> Scheduled at 02:00 PM</span>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <p>Preparing shipment for Jakarta Coffee House</p>
                                            <div class="timeline-meta">
                            ...
                            <div class="dashboard-card-footer">
                                <a href="#" class="btn-view-all">View All Production Activities <i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="dashboard-card mt-4">
                            ...
                            <div class="dashboard-card-body">
                                <div class="transactions-table-wrapper">
                                    <table class="transactions-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><span class="text-muted">#TRX-</span>8721</td>
                                                <td>Cafe Nusantara</td>
                                                <td>Arabica Aceh Gayo (5kg)</td>
                                                <td>Rp 1.250.000</td>
                                                <td><span class="badge badge-success">Completed</span></td>
                                                <td>Today</td>
                                            </tr>
                                            <tr>
                                                <td><span class="text-muted">#TRX-</span>8720</td>
                                                <td>Jakarta Coffee House</td>
                                                <td>Robusta Lampung (10kg)</td>
                                                <td>Rp 1.800.000</td>
                                                <td><span class="badge badge-warning">Processing</span></td>
                                                <td>Yesterday</td>
                                            </tr>
                                            <tr>
                                                <td><span class="text-muted">#TRX-</span>8719</td>
                                                <td>Bandung Brew Co.</td>
                                                <td>Java Preanger (3kg)</td>
                                                <td>Rp 900.000</td>
                                                <td><span class="badge badge-success">Completed</span></td>
                                                <td>Yesterday</td>
                                            </tr>
                                            <tr>
                                                <td><span class="text-muted">#TRX-</span>8718</td>
                                                <td>Surabaya Coffee Shop</td>
                                                <td>Mixed Varieties (8kg)</td>
                                                <td>Rp 2.100.000</td>
                                                <td><span class="badge badge-success">Completed</span></td>
                                                <td>2 days ago</td>
                                            </tr>
                            ...
                            <div class="dashboard-card-footer">
                                <a href="#" class="btn-view-all">View All Transactions <i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
