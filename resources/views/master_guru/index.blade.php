...
@section('konten')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <!-- Tombol Tambah Guru -->
                <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#tambahGuruModal">
                    Tambah Guru
                </button>
                <!-- Tombol Ekspor -->
                <a href="{{ route('guru.export') }}" class="btn btn-success mb-3">Export Excel</a>
                <!-- Tombol Impor -->
                <button type="button" class="btn btn-info mb-3" data-toggle="modal" data-target="#importGuruModal">
                    Import Excel
                </button>
                <a href="{{ route('guru.template') }}" class="btn btn-danger mb-3">Template Excel</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (!empty($guru->foto) && file_exists(public_path('uploads/guru/' . $guru->foto)))
                                                <img src="{{ url('uploads/guru/' . $guru->foto) }}" width="50">
                                            @else
                                                Belum ada foto
                                            @endif
                                        </td>
    ...
    <!-- Modal Impor Guru -->
    <div class="modal fade" id="importGuruModal" tabindex="-1" role="dialog" aria-labelledby="importGuruModalLabel"
        aria-hidden="true">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tabel-data').DataTable({
                ...
                columnDefs: [
                    { responsivePriority: 1, targets: [0, 7] },    // Nama & Aksi columns
                    { responsivePriority: 2, targets: [3, 4] },    // NIP & NIK columns
